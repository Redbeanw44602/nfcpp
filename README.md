...
For non-xmake projects.
 ...
 - ***TODO*** I wil submit this package to conan as soon as possible.
...
A key feature of NFC++ is its support for transforming bitstreams (or bytestreams) to be transmitted at compile time (or runtime). This is supported by the `NfcTransmitData` template and includes several useful transformers by default; you will learn more in the documentation.
...
> [!CAUTION]
> With crapto1 enabled, this library is now subject to the GPLv3 license, and you must comply with the new license.

## License

LGPLv3 by default, GPLv3 when crapto1 is used.
